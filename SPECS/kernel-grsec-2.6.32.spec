...
BuildKernel() {
    ...
    %{__cp} -a --parents include/linux/*.h $RPM_BUILD_ROOT/lib/modules/$KernelVer/build
    ...
    popd > /dev/null
    %{__cp} -a include/linux/*.h $RPM_BUILD_ROOT/lib/modules/$KernelVer/build/include/linux
